...
│     ①           ②           ③           ④           ⑤          │
│    (✓)───────▶(✓)───────▶(●)───────▶( )───────▶( )            │
│  Analyst    Developer    Tester     Deploy     Monitor           │
│                                                                  │
│  ┌────────────────────────────────────────────────────────────┐  │
│  │ 10:01:02  [requirement_analyst]                            │  │
│  │           Task analyzed. Moving to code development.       │  │
│  │                                                            │  │
│  │ 10:01:15  [code_developer]                                 │  │
│  │           Code generated: ma_crossover_strategy.py (2.1KB) │  │
│  │                                                            │  │
│  │ 10:01:28  [test_engineer]                                  │  │
│  │           Running tests...                                 │  │
│  └────────────────────────────────────────────────────────────┘  │
│                                                                  │
│  ┌──────┬───────┬────────┬───────────┐                          │
│  │ Code │ Tests │ Deploy │ Audit Log │                          │
│  ├──────┴───────┴────────┴───────────┤                          │
│  │ class MACrossoverStrategy:        │                          │
│  │     def __init__(self, short=5):  │                          │
...
- Live event feed showing each agent's output
- Tabbed results viewer (Code / Tests / Deploy / Audit Log)
- Syntax-highlighted Python code output
...
│   ├── app.py                      # FastAPI 应用工厂
│   ├── routes/                     # 路由 (页面 / 工作区 / 工作流)
│   ├── services/                   # LangGraph → SSE 桥接
